...
from DEXTR_KerasTensorflow_master.networks import resnet
from DEXTR_KerasTensorflow_master.mypath import Path


class DEXTR(object):
    """Pyramid Scene Parsing Network by Hengshuang Zhao et al 2017"""

    def __init__(self, nb_classes, resnet_layers, input_shape, weights_filepath, num_input_channels=4,
